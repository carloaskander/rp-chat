      ...
      {profiles.length === 0 ? (
        ...
        <div className="space-y-2">
          {profiles.map((profile) => {
            ...
            <article
              key={profile.id}
              className="flex items-center justify-between rounded-[2px] bg-zinc-900/50 px-4 py-3 transition hover:bg-zinc-900/80"
            >
              <div className="flex min-w-0 flex-1 items-center gap-3 text-left">
                  <div className="flex h-9 w-9 items-center justify-center rounded-[2px] bg-zinc-800/80 text-[11px] font-semibold text-zinc-300">
                    API
                  </div>
                ...
                <div className="ml-3 flex items-center gap-2">
                  <button
                    ...
                    className="rounded-[14px] px-2.5 py-1 text-xs text-zinc-300 transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="rounded-[14px] px-2.5 py-1 text-xs text-zinc-300 transition hover:bg-zinc-800"
                  >
                    Edit
                  </button>
                  <button
                    ...
                    className="rounded-[14px] px-2.5 py-1 text-xs text-zinc-400 transition hover:bg-zinc-800 hover:text-zinc-200"
                  >
