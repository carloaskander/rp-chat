        ...
        {activeTab === "account" && (
          <section className="p-2">
            <div className="flex items-start gap-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-zinc-900 text-zinc-100">
                ...
                {isPreviewMode ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="mt-4 inline-flex items-center rounded-xl px-4 py-2 text-sm font-medium text-zinc-300 transition hover:bg-zinc-900/70 hover:text-zinc-100"
                    >
                      Log out
                    </button>
                  </>
