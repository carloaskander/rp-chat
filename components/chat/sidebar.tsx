...
export function Sidebar({
  ...
  const sidebarButtonClassName = (isActive: boolean) =>
    `flex w-full items-center gap-3 rounded-[8px] px-3 py-3 text-left text-[15px] transition sm:py-2.5 sm:text-sm ${
      isActive
  ...
  return (
    <aside className={className ?? "flex h-full w-full max-w-72 flex-col px-2 py-2"}>
      ...
      <div className="relative border-t border-zinc-900/90 px-3 pb-3 pt-3" ref={accountMenuRef}>
        {isAccountMenuOpen && (
          <div className="absolute inset-x-3 bottom-[calc(100%+0.35rem)] rounded-[8px] bg-zinc-950/98 p-2 shadow-2xl shadow-black/40 backdrop-blur">
            ...
            <Link
              ...
              className="flex items-center gap-3 rounded-[8px] px-3 py-2.5 text-sm text-zinc-300 transition hover:bg-zinc-900 hover:text-zinc-100"
            >
            ...
            {isPreviewMode ? (
              <button
                ...
                className="flex w-full items-center gap-3 rounded-[8px] px-3 py-2.5 text-left text-sm text-zinc-300 transition hover:bg-zinc-900 hover:text-zinc-100"
              >
                <CircleUserRound className="h-4 w-4" />
                <span>Sign in</span>
              </button>
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-[8px] bg-zinc-900/80 px-3 py-3 text-left transition hover:border-zinc-700 hover:bg-zinc-900"
        >
