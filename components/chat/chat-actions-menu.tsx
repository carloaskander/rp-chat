          ...
          >
            {onRenameChat && (
              <button
                ...
                className="w-full rounded-none px-3 py-2 text-left text-sm text-zinc-200 hover:bg-zinc-800"
              >
                Rename chat
              </button>
            )}
            {onDeleteChat && (
              <button
                ...
                className="w-full rounded-none px-3 py-2 text-left text-sm text-zinc-300 hover:bg-zinc-800"
              >
                Delete chat
              </button>
            )}
