      ...
      >
        ...
        >
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 px-1">
            ...
            >
              <span className="hidden origin-left whitespace-nowrap md:inline md:scale-100 md:text-[13px] md:leading-none">API Profile</span>
            ...
            >
              <span className="hidden origin-left whitespace-nowrap md:inline md:scale-100 md:text-[13px] md:leading-none">Character Preset</span>
            ...
            >
              <span className="hidden origin-left whitespace-nowrap md:inline md:scale-100 md:text-[13px] md:leading-none">Instruction Preset</span>
